...
enum class RtalScreenId : uint16_t {
  ...
  FxMain          = 400,
  FxRemoteDelay   = 401,   // Delay main
  FxRemoteTiming  = 402,
  FxRemoteTone    = 403,
  FxRemoteDuck    = 404,
  FxRemoteModCore = 405,   // Build0039 shared modulation core
  FxRemoteModStereo = 406,
  FxRemoteChorus = 407,      // Build0041 stereo chorus
  FxRemoteFlanger = 408,     // Build0042 stereo flanger
  FxRemoteFlangerTone = 409, // Build0042 feedback HPF/saturation
  FxRemotePhaser = 410,      // Build0043 stereo phaser
  FxRemotePhaserTone = 411,  // Build0043 feedback/color
  FxRemoteModSelect = 412,   // Build0044 central selector
  FxRemoteWidth = 413,       // Build0045 final Mid/Side stereo width
  FxRemoteReverb = 414,      // Build0046 4-line FDN reverb main
  FxRemoteReverbTone = 415,  // Build0046 damping/predelay
...
inline void rtalUiSetSelectedMultiPart(uint8_t) {}
#endif
