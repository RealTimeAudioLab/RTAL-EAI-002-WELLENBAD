...
|---|---|---|
| **v1.5.0 B0074F A015 FINAL** | **v1.0.0 FX0047 FINAL** | **Recommended release pair** |
...
Keep all supplied `.ino`, `.h` and `.cpp` files together in the `WB0074F` sketch directory.
